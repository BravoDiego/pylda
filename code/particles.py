...
class AnimationPlayer(pygame.sprite.Sprite):
    def __init__(self):
        self.frames = {
            # magic
    ...
    def reflect_images(self, frames) -> list:
        ...
        for frame in frames:
            ...
            reflected_frames.append(reflected_frame)
        return reflected_frames

    def create_grass_particles(self, pos, groups):
        grass_frames = choice(self.frames['leaf'])
        ParticleEffect(pos, grass_frames, groups)
    
    def create_particles(self, attack_type, pos, groups):
        frames = self.frames.get(attack_type)
