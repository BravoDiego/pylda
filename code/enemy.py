...
class Enemy(Entity):
    def __init__(self, monster_name, pos, groups, obstacles_sprites, damage_player, trigger_death_particles, add_xp):
        ...
        self.image = self.animations[self.status][self.frame_index]  # set the initial image
        ...
        self.damage_player = damage_player  # function to damage the player
        self.trigger_death_particles = trigger_death_particles  # function to trigger death particles
        self.add_xp = add_xp  # function to add experience points
