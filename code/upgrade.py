...
class Upgrade:
    ...
    def create_items(self):
        ...
        for i, attribute in enumerate(self.attribute_names):
            ...
            increament = full_width // self.attribute_nr
            left = increament * i + (increament - self.width) // 2
...
class Item:
    ...
    def display_bar(self, surface, value, max_value, selected):
        ...
        relative_number = int((value / max_value) * full_height)
    ...
    def display(self, surface, selection_num, name, value, max_value, cost):
        ...
        self.display_bar(surface, value, max_value, selection_num == self.index)